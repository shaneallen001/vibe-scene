...
async function run() {
    ...
    const configurations = [
        {
            name: 'Connectivity MST Straight',
            size: 'medium',
            connectivity: 'mst',
            corridorStyle: 'straight'
        },
        {
            name: 'Connectivity MST Loops LPath',
            size: 'medium',
            connectivity: 'mst_loops',
            corridorStyle: 'l_path'
        },
        {
            name: 'Connectivity Full Errant',
            size: 'medium',
            connectivity: 'full', // Might be messy!
    ...
    for (const config of configurations) {
        ...
        try {
            ...
            const outputPath = path.join(outputDir, `connectivity_${safeName}.png`);
